...
func main() {
	...
	m.Methods("PUT").Path("/employees/status/update").HandlerFunc(osvc.UpdateEmployStatus)
	m.Methods("GET").Path("/employees/status/cancel/{id}").HandlerFunc(osvc.CancelEmployStatus)
